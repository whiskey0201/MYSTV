...
```json
{"key":"csp_appysv2_tkys", "name":"天空影视(M2)", "type":3, "api":"csp_AppYsV2","searchable":1,"quickSearch":0,"filterable":1,"ext":"星空影视###https://zhijikk.coding.net/p/mao/d/config/git/raw/master/appysv2.json"},
